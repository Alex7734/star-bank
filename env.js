...
const BUNDLE_ID = 'com.starbank'; // ios bundle id
const PACKAGE = 'com.starbank'; // android package name
const NAME = 'Star Bank'; // app name
const EXPO_ACCOUNT_OWNER = 'Alex7734'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'starBankApp'; // app scheme
